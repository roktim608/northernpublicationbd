...
const getters = require('./getters-621db5cc.js');
  ...
  async componentDidLoad() {
    ...
    this.unlistenToFormState = store.onChange('formState', () => {
      ...
      if (!((_a = mutations.state === null || mutations.state === void 0 ? void 0 : mutations.state.checkout) === null || _a === void 0 ? void 0 : _a.payment_method_required))
        return;
      if ('finalizing' === getters$1.currentFormState()) {
        this.submit();
      }
  ...
  createOrUpdateElements() {
    ...
    if (!this.elements) {
      ...
      this.elements
        ...
        defaultValues: {
          billingDetails: {
            name: (_c = mutations.state.checkout) === null || _c === void 0 ? void 0 : _c.name,
            email: (_d = mutations.state.checkout) === null || _d === void 0 ? void 0 : _d.email,
            address: {
              line1,
              line2,
              city,
      ...
      this.element.on('change', (event) => {
        ...
        if (event.complete) {
          this.scPaymentInfoAdded.emit({
            checkout_id: (_a = mutations.state.checkout) === null || _a === void 0 ? void 0 : _a.id,
            currency: (_b = mutations.state.checkout) === null || _b === void 0 ? void 0 : _b.currency,
