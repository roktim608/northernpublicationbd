...
const ui = require('./ui-9bbf7d3b.js');
...
const ScCartIcon = class {
  ...
  toggleCart() {
    return ui.store.set('cart', { ...ui.store.state.cart, ...{ open: !ui.store.state.cart.open } });
  }
  render() {
    var _a, _b, _c;
