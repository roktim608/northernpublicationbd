...
const ScSubscription = class {
  ...
  render() {
    ...
    return (index.h("sc-dashboard-module", { heading: this.heading || wp.i18n.__('Current Plan', 'surecart'), class: "subscription", error: this.error }, !!this.subscription && (index.h("sc-flex", { slot: "end", class: "subscription__action-buttons" }, getQueryArg.getQueryArg(window.location.href, 'action') !== 'update_payment_method' && (index.h("sc-button", { type: "link", href: addQueryArgs.addQueryArgs(window.location.href, {
