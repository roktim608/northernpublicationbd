...
const index$1 = require('./index-be3a6f35.js');
const getters = require('./getters-1e382cac.js');
const getters$1 = require('./getters-a503beab.js');
...
const mutations$3 = require('./mutations-8708a408.js');
...
const ScOrderConfirmProvider = class {
  ...
  async confirmOrder() {
    ...
    try {
      ...
      // get success url.
      const successUrl = ((_c = (_b = mutations.state.checkout) === null || _b === void 0 ? void 0 : _b.metadata) === null || _c === void 0 ? void 0 : _c.success_url) || this.successUrl;
      if (successUrl) {
...
const ScSessionProvider = class {
  ...
  async handleFormSubmit() {
    ...
    try {
      mutations.state.checkout = await index$1.finalizeCheckout({
        ...
        query: {
          ...
          return_url: addQueryArgs.addQueryArgs(window.location.href, {
            ...(((_c = mutations.state === null || mutations.state === void 0 ? void 0 : mutations.state.checkout) === null || _c === void 0 ? void 0 : _c.id) ? { checkout_id: (_d = mutations.state === null || mutations.state === void 0 ? void 0 : mutations.state.checkout) === null || _d === void 0 ? void 0 : _d.id } : {}),
      ...
      if (['paid', 'processing'].includes((_e = mutations.state.checkout) === null || _e === void 0 ? void 0 : _e.status)) {
        this.scPaid.emit();
      }
      if ((_j = (_h = (_g = (_f = mutations.state.checkout) === null || _f === void 0 ? void 0 : _f.payment_intent) === null || _g === void 0 ? void 0 : _g.processor_data) === null || _h === void 0 ? void 0 : _h.mollie) === null || _j === void 0 ? void 0 : _j.checkout_url) {
