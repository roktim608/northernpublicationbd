...
const ScSubscriptionDetails = class {
  ...
  render() {
    ...
    })))), !this.subscription.payment_method && (index.h("div", null, index.h("sc-tag", { type: "warning" }, index.h("div", { class: "subscription-details__missing-method" }, index.h("sc-icon", { name: "alert-triangle" }), wp.i18n.__('Payment Method Missing', 'surecart')))))));
  }
