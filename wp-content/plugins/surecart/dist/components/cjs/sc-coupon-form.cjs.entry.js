...
const ScCouponForm = class {
  ...
  handleDiscountChange(newValue, oldValue) {
    ...
    if ((_d = (_c = this === null || this === void 0 ? void 0 : this.discount) === null || _c === void 0 ? void 0 : _c.promotion) === null || _d === void 0 ? void 0 : _d.code) {
      ...
      wp.i18n.__('Coupon code %1$s added. %2$s applied.', 'sc-coupon-form'), ((_e = newValue === null || newValue === void 0 ? void 0 : newValue.promotion) === null || _e === void 0 ? void 0 : _e.code) || this.input.value || '', price.getHumanDiscount((_f = this === null || this === void 0 ? void 0 : this.discount) === null || _f === void 0 ? void 0 : _f.coupon));
      index$1.speak(message, 'assertive');
    }
    else {
      // Translators: %s is the coupon code.
      const message = wp.i18n.__('Coupon code removed.', 'sc-coupon-form');
      index$1.speak(message, 'assertive');
    }
    setTimeout(() => {
      var _a, _b;
  ...
  render() {
    ...
    if ((_b = (_a = this === null || this === void 0 ? void 0 : this.discount) === null || _a === void 0 ? void 0 : _a.promotion) === null || _b === void 0 ? void 0 : _b.code) {
      ...
      return (index.h("sc-line-item", { exportparts: "description:info, price-description:discount, price:amount" }, index.h("span", { slot: "description" }, index.h("div", { part: "discount-label" }, wp.i18n.__('Discount', 'surecart')), index.h("sc-tag", { exportparts: "base:coupon-tag", type: "success", class: "coupon-tag", clearable: true, onScClear: () => {
          this.scApplyCoupon.emit(null);
          this.open = false;
        }, onKeyDown: e => {
        ...
        }, ref: el => (this.couponTag = el), role: "button", "aria-label": wp.i18n.sprintf(wp.i18n.__('Press enter to remove coupon code %s.', 'surecart'), ((_d = (_c = this === null || this === void 0 ? void 0 : this.discount) === null || _c === void 0 ? void 0 : _c.promotion) === null || _d === void 0 ? void 0 : _d.code) || this.input.value || '') }, (_f = (_e = this === null || this === void 0 ? void 0 : this.discount) === null || _e === void 0 ? void 0 : _e.promotion) === null || _f === void 0 ? void 0 : _f.code)), humanDiscount && (index.h("span", { class: "coupon-human-discount", slot: "price-description" }, this.translateHumanDiscountWithDuration(humanDiscount))), index.h("span", { slot: "price" }, index.h("sc-format-number", { type: "currency", currency: this === null || this === void 0 ? void 0 : this.currency, value: this === null || this === void 0 ? void 0 : this.discountAmount }))));
    }
