...
const ScStackedListRow = class {
  ...
  render() {
    ...
    return (index.h(Tag, { href: this.href, target: this.target, part: "base", class: {
        'list-row': true,
      ...
      } }, index.h("span", { class: "list-row__prefix" }, index.h("slot", { name: "prefix", onSlotchange: () => this.handleSlotChange() })), index.h("slot", { onSlotchange: () => this.handleSlotChange() }), index.h("span", { class: "list-row__suffix" }, index.h("slot", { name: "suffix", onSlotchange: () => this.handleSlotChange() }))));
  }
