...
import { p as productNameWithPrice } from './price-1a399968.js';
...
const ScSubscription = class {
  ...
  render() {
    ...
    return (h("sc-dashboard-module", { heading: this.heading || wp.i18n.__('Current Plan', 'surecart'), class: "subscription", error: this.error }, !!this.subscription && (h("sc-flex", { slot: "end", class: "subscription__action-buttons" }, getQueryArg(window.location.href, 'action') !== 'update_payment_method' && (h("sc-button", { type: "link", href: addQueryArgs(window.location.href, {
