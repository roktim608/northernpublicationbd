...
import { s as state, o as onChange, r as removeQueryArgs } from './mutations-36a3cfa8.js';
import { d as updateCheckout, e as expand, f as finalizeCheckout, g as fetchCheckout, c as createOrUpdateCheckout } from './index-5e0d7939.js';
import { c as currentFormState } from './getters-2c9ecd8c.js';
import { s as shippingAddressRequired } from './getters-662a5825.js';
...
import { c as clearCheckout } from './mutations-215400cc.js';
...
const ScOrderConfirmProvider = class {
  ...
  async confirmOrder() {
    ...
    try {
      ...
      clearCheckout();
      // get success url.
      const successUrl = ((_c = (_b = state.checkout) === null || _b === void 0 ? void 0 : _b.metadata) === null || _c === void 0 ? void 0 : _c.success_url) || this.successUrl;
      if (successUrl) {
...
const ScSessionProvider = class {
  ...
  async handleFormSubmit() {
    ...
    try {
      state.checkout = await finalizeCheckout({
        ...
        query: {
          ...
          return_url: addQueryArgs(window.location.href, {
            ...(((_c = state === null || state === void 0 ? void 0 : state.checkout) === null || _c === void 0 ? void 0 : _c.id) ? { checkout_id: (_d = state === null || state === void 0 ? void 0 : state.checkout) === null || _d === void 0 ? void 0 : _d.id } : {}),
      ...
      if (['paid', 'processing'].includes((_e = state.checkout) === null || _e === void 0 ? void 0 : _e.status)) {
        this.scPaid.emit();
      }
      if ((_j = (_h = (_g = (_f = state.checkout) === null || _f === void 0 ? void 0 : _f.payment_intent) === null || _g === void 0 ? void 0 : _g.processor_data) === null || _h === void 0 ? void 0 : _h.mollie) === null || _j === void 0 ? void 0 : _j.checkout_url) {
