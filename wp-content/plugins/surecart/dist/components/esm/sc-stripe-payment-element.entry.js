...
import { a as availableProcessors } from './getters-ed4600be.js';
import { o as onChange, s as state } from './mutations-36a3cfa8.js';
      ...
      this.element.on('change', (event) => {
        ...
        if (event.complete) {
          this.scPaymentInfoAdded.emit({
            ...
            currency: (_b = state.checkout) === null || _b === void 0 ? void 0 : _b.currency,
            processor_type: 'stripe',
            payment_method: {
              billing_details: {
                email: (_c = state.checkout) === null || _c === void 0 ? void 0 : _c.email,
                name: (_d = state.checkout) === null || _d === void 0 ? void 0 : _d.name,
              },
            },
          });
        }
