...
import { p as productNameWithPrice, i as intervalString } from './price-1a399968.js';
...
const ScSubscriptionDetails = class {
  ...
  render() {
    ...
    })))), !this.subscription.payment_method && (h("div", null, h("sc-tag", { type: "warning" }, h("div", { class: "subscription-details__missing-method" }, h("sc-icon", { name: "alert-triangle" }), wp.i18n.__('Payment Method Missing', 'surecart')))))));
  }
