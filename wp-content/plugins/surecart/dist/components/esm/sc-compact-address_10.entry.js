...
import { s as state$1, o as onChange } from './mutations-36a3cfa8.js';
...
import { i as intervalString, b as getFormattedPrice } from './price-1a399968.js';
import { g as getFeaturedProductMediaAttributes, s as sizeImage } from './media-8435dec0.js';
import { l as lockCheckout, b as unLockCheckout } from './mutations-215400cc.js';
import { c as createOrUpdateCheckout } from './index-5e0d7939.js';
import { f as fullShippingAddressRequired, a as checkoutIsLocked } from './getters-662a5825.js';
  ...
  render() {
    ...
    if (fullShippingAddressRequired() || this.full || this.requireName || this.showName) {
      return (h("sc-address", { exportparts: "label, help-text, form-control, input__base, select__base, columns, search__base, menu__base", ref: el => (this.input = el), label: this.label || wp.i18n.__('Shipping Address', 'surecart'), placeholders: {
        ...
        }, required: this.required, loading: formLoading(), address: this.address, "show-name": this.showName, "require-name": this.requireName, onScChangeAddress: e => this.updateAddressState(e.detail) }));
    }
    return (h("sc-compact-address", { ref: el => (this.input = el), required: this.required, loading: formLoading(), address: this.address, placeholders: {
        name: this.namePlaceholder,
        country: this.countryPlaceholder,
        city: this.cityPlaceholder,
        line_1: this.line1Placeholder,
