  ...
  renderContent() {
    ...
    return (h(Fragment, null, (((_c = checkout === null || checkout === void 0 ? void 0 : checkout.line_items) === null || _c === void 0 ? void 0 : _c.data) || []).map(item => {
      ...
      checkout.tax_percent, "%)"), h("sc-format-number", { slot: "price", style: {
        ...
        'width': '100%',
        '--price-size': 'var(--sc-font-size-x-large)',
      } }, h("span", { slot: "title" }, wp.i18n.__('Amount Paid', 'surecart')), h("span", { slot: "price" }, h("sc-format-number", { type: "currency", currency: (_h = checkout === null || checkout === void 0 ? void 0 : checkout.charge) === null || _h === void 0 ? void 0 : _h.currency, value: ((_j = checkout === null || checkout === void 0 ? void 0 : checkout.charge) === null || _j === void 0 ? void 0 : _j.amount) ? ((_k = checkout === null || checkout === void 0 ? void 0 : checkout.charge) === null || _k === void 0 ? void 0 : _k.amount) - ((_l = checkout === null || checkout === void 0 ? void 0 : checkout.charge) === null || _l === void 0 ? void 0 : _l.refunded_amount) : 0 })), h("span", { slot: "currency" }, (_m = checkout === null || checkout === void 0 ? void 0 : checkout.charge) === null || _m === void 0 ? void 0 : _m.currency)))));
  }
  render() {
